...
#if USE_WFLASH
	CY_ALIGN(32)
	uint8_t write_buf[64] = {0xAB, 0xCD, 0xEF, 0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0,
...
/* Option 2: 512-byte data array - FOR CFLASH*/
	...
	uint8_t write_buf[512] = {
		...
		0xEE, 0xFF, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0xAB, 0xCD, 0xEF, 0x12, 0x34, 0x56,
		0x78, 0x9A, 0xBC, 0xDE, 0xF0, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99,
		...
		,
		...
		,
	...
	for (size_t i = 0; i < sizeof(read_buf); i += 16) {
		LOG_INF("[0x%04zx] %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X "
			"%02X %02X %02X %02X",
			i, read_buf[i], read_buf[i + 1], read_buf[i + 2], read_buf[i + 3],
	...
	// Testing Erase
	LOG_INF("Erasing 0x%x bytes from sector at offset 0x%x after write", TEST_SIZE,
		TEST_OFFSET);
	ret = flash_erase(flash_dev, TEST_OFFSET, TEST_SIZE);
	if (ret != 0) {
		LOG_ERR("Erase failed: %d", ret);
