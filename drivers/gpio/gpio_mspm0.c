...
#elif CONFIG_SOC_SERIES_MSPM0L122X_L222X
#define GPIOA_NODE DT_NODELABEL(gpioa)
...
static const uint8_t gpiob_pincm_lut[NUM_GPIOB_PIN] = {
...
static const uint8_t gpioc_pincm_lut[NUM_GPIOC_PIN] = {
