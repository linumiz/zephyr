...
#ifndef ZEPHYR_SOC_INFINEON_AURIX_TC4XX_PINCTRL_SOC_H_
#define ZEPHYR_SOC_INFINEON_AURIX_TC4XX_PINCTRL_SOC_H_

#include <stdint.h>
#include <zephyr/devicetree.h>
#include <zephyr/dt-bindings/pinctrl/aurix-pinctrl.h>

struct tc4xx_pinctrl {
	uint32_t port: 6;
	uint32_t pin: 4;
	uint32_t alt: 4;
	uint32_t type: 4;
...
typedef struct tc4xx_pinctrl pinctrl_soc_pin_t;
...
#endif /* ZEPHYR_SOC_INFINEON_AURIX_TC4XX_PINCTRL_SOC_H_ */
