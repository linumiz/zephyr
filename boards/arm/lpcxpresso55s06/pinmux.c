...
static int lpcxpresso_55s06_pinmux_init(const struct device *dev)
{
	...
	/* PORT0 PIN14 is configured as FC4_TXD_SCL_MISO_WS */
	pinmux_pin_set(port0, 14, IOCON_PIO_FUNC5  |
				  IOCON_PIO_MODE_INACT |
				  IOCON_PIO_SLEW_STANDARD |
				  IOCON_PIO_INV_DI |
				  IOCON_PIO_DIGITAL_EN |
	...
	/* PORT0 PIN13 is configured as FC4_RXD_SDA_MOSI_DATA */
	pinmux_pin_set(port0, 13, IOCON_PIO_FUNC5  |
				  IOCON_PIO_MODE_INACT |
				  IOCON_PIO_SLEW_STANDARD |
				  IOCON_PIO_INV_DI |
				  IOCON_PIO_DIGITAL_EN |
